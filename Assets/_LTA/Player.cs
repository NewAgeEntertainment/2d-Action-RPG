...
public class Player : MonoBehaviour
{
    ...
    private void Start()
    {
        ...
        stateMachine.Initialize(); // Initialize the state machine with the idle state
    }
    ...
    private void CheckForDashInput()
    {
        ...
        if (Input.GetKeyDown(KeyCode.LeftShift)) // Check if the left shift key is pressed and the dash cooldown is over  
        {
            ...
            stateMachine.ChangeState(stateMachine.dashState); // Change to the dash state when the left shift key is pressed  
        }
    }
