...
public class PlayerAnimationTriggers : MonoBehaviour
{
    ...
    private void EndAnimationTrigger() // This method is called when the animation trigger is activated.  
    {
        player.EndAnimationTrigger(); // Call the AnimationTrigger method of the Player component.  
    }
